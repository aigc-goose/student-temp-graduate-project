...
import com.example.xm.graduate_project.entity.Files;
import com.example.xm.graduate_project.mapper.FileMapper;
...
public class FileController {
    ...
    @DeleteMapping("/{fid}")
    public Result delete(@PathVariable Integer fid) {
